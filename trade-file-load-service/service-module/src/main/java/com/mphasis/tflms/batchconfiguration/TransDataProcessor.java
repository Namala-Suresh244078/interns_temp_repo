...
public class TransDataProcessor implements ItemProcessor<String[],TransDataValidationWrapper> {
    ...
    private static final int IDX_TRANSACTION_SUBTYPE = 14;
    ...
    private static final DateTimeFormatter DATE_TIME_FORMATTER_PATTERN=DateTimeFormatter.ofPattern("yyyyMMdd");
    ...
    public TransDataValidationWrapper process(String[] tradeData) throws Exception {
        TransactionData transactionData = TransactionData.builder()
                .fileHeaderDate(LocalDate.parse(tradeData[IDX_FILE_HEADER_DATE], DATE_TIME_FORMATTER_PATTERN))
                ...
                .doNotReportFlag(Boolean.parseBoolean(tradeData[IDX_DO_NOT_REPORT_FLAG]))
                ...
                .transactionSubtype(tradeData[IDX_TRANSACTION_SUBTYPE])
        ...
        List<FileValidation> fileValidationResult = tradeDataValidatorService.validateTradeData(transactionData);

        return TransDataValidationWrapper.dataValidationWrapper(transactionData,fileValidationResult);
    }
}
